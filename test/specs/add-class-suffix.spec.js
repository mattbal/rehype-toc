...
describe("options.addClassSuffix", () => {
  it("should add suffix to classnames if no configuration is provided", async () => {
  ...
  it("should add suffix to classnames if all are true", async () => {
    let results = await process(
      `
      <html>
        <body>
  ...
  it("should add suffix to classnames if only ol is true", async () => {
    let results = await process(
      `
      <html>
        <body>
  ...
  it("should add suffix to classnames if only li is true", async () => {
    let results = await process(
      `
      <html>
        <body>
  ...
  it("should add suffix to classnames if only a is true", async () => {
    let results = await process(
      `
      <html>
        <body>
